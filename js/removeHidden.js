let removeHidden = document.querySelector('.img-upload__overlay')
let locateHidden = document.querySelector('#upload-file')
let closeButton = document.querySelector('#upload-cancel')
let resetData = document.querySelector('.img-upload__form')
function close(e){
